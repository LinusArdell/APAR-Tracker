...
//                        dispatchTakePictureIntent(takePictureLauncher);
    ...
    private void uploadData() {
        ...
        DataClass dataClass = new DataClass(kodeQR, kondisiString, imageURL, currentDate, area);

        FirebaseDatabase.getInstance().getReference("Input").child(area).child(kodeQR).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
